    ...
    render() {
      ...
      return (
          ...
          <div className="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12 devFondp2">
            ...
            <p className="devFondp2Pera">KRL represented by Ms. Khumar Raza worked with LIGHT-F project since January 2018. They helped us to develop project logo, image color and logo usage guidelines. They also designed carious materials using logo and brand color such as leaflets and catalogues. They are young and energetic,
