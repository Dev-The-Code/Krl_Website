                    ...
                    <div className="row DevWeStandFor">
                        ...
                        <div className="col-xl-10 col-lg-10 col-md-10 col-12">
                            ...
                            <div className="row">
                                ...
                                <img href="#" className="weHelp" src={require('../../../Assets/Images/AboutPageImages/Aboutpage-02.jpg')} />
                                </div>
                                <div className="col-xl-3 col-lg-3 col-md-3 col-12 ">
                                <img href="#" className="youHelp" src={require('../../../Assets/Images/AboutPageImages/Aboutpage-03.jpg')} />
                                </div>
                                <div className="col-xl-3 col-lg-3 col-md-3 col-12 ">
                                <img href="#" className="audience" src={require('../../../Assets/Images/AboutPageImages/Aboutpage-04.jpg')} />
                                </div>
                                <div className="col-xl-3 col-lg-3 col-md-3 col-12 ">
                                <img href="#" className="helpOthers" src={require('../../../Assets/Images/AboutPageImages/Aboutpage-05.jpg')} />
                                </div>
                            </div>
                    ...
                    <div className="row DevWeStandForMob">
                        ...
                        <div className="col-10 DevWeStandForChildMob">
                            ...
                            <div className="col-12 DevweHelpMob">
                                <img href="#" className="weHelpMob" src={require('../../../Assets/Images/AboutPageImages/Aboutpage-02.jpg')} />
                            </div>
                            <div className="col-12 DevweHelpMob">
                                <img href="#" className="youHelpMob" src={require('../../../Assets/Images/AboutPageImages/Aboutpage-03.jpg')} />
                            </div>
                            <div className="col-12 DevweHelpMob">
                                <img href="#" className="audienceMob" src={require('../../../Assets/Images/AboutPageImages/Aboutpage-04.jpg')} />
                            </div>
                            <div className="col-12 DevweHelpMob">
                                <img href="#" className="helpOthersMob" src={require('../../../Assets/Images/AboutPageImages/Aboutpage-05.jpg')} />
                            </div>
                        </div>
                        <div className="col-1 "></div>
